...
public class Enemy_Dash_NoCollider : Enemy {
    ...
    private void StateUpdate()
    {
       ...
       {
           if (stateActiveFrames[(int)PlayerState.lockOn] > lockTime)
           {
       ...
       {
           if (stateActiveFrames[(int)PlayerState.recover] > recoverTime)
           {
