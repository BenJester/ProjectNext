...
using UnityEditor;
    ...
    [CustomEditor(typeof(MovingObjectByWayPoint))]
    public class WayPointEditor : Editor
    {
        MovingObjectByWayPoint m_MovingPlatform;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginChangeCheck();
            MovingObjectByWayPoint.MovingPlatformType platformType = (MovingObjectByWayPoint.MovingPlatformType)EditorGUILayout.EnumPopup("Looping", m_MovingPlatform.platformType);
            if (EditorGUI.EndChangeCheck())
            {
        ...
        private void OnSceneGUI()
        {
            ...
            for (int i = 0; i < m_MovingPlatform.localNodes.Length; ++i)
            {
                ...
                if (i == 0)
                {
                    if (m_MovingPlatform.platformType != MovingObjectByWayPoint.MovingPlatformType.LOOP)
                        continue;
        ...
        void MovePreview()
        {
            ...
            WayPointPreview.preview.transform.position = m_MovingPlatform.transform.TransformPoint(localPos);
